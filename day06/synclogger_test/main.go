...
import (
	"github.com/kimalancs/LearningGolang/day06/synclogger"
)

var log synclogger.Logger
...
func main() {
	log = synclogger.NewConsoleLogger("info") // 构建结果就是ConsoleLogger类型
	...
	log = synclogger.NewFileLogger("warn", "./log", "xxx.log", 512*1024) // 构造结果是*FileLogger类型
